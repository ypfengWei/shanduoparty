...
public class CloudData {
	...
	public static final String accountImport = "im_open_login_svc/account_import";//账号导入
	public static final String setPortrait = "profile/portrait_set";//设置资料
    ...
    public static final String getGroupInfo = "group_open_http_svc/get_group_info";//获取群组详细资料
